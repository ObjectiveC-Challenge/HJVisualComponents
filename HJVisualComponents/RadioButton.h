...
/// @brief Button's orientation. Can ben horizontgal or vertical.
@property (nonatomic) IBInspectable Orientation orientation;
...
/// @param orientationP Orientation that represents the button's orientation. Can ben horizontgal or vertical.
/// @returns RadioButton
-(instancetype)initWithMultiplier:(CGFloat)multiplierP selectedColor:(UIColor*)selectedColorP unselectedColor:(UIColor*)unselectedColorP fontColor:(UIColor*)fontColorP orientation:(Orientation)orientationP;
